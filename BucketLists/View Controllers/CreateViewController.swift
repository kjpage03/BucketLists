    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if !deleteButtonWasTapped {
            ...
            if let index = indexInArray {
                ...
                let newBucketList: BucketList = BucketList(owner: name, items: [Item(name: "Example Item", description: "", location: nil, goalDate: Date(), isComplete: true, details: "Write about your experience!", imageArray: [], numofSteps: 0, stepnames: [], stepsCompleted: [])], color: Color(uiColor: color))
