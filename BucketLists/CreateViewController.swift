    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if !deleteButtonWasTapped {
            ...
            dataController.saveData(lists: bucketLists)
                ...
                let newBucketList: BucketList = BucketList(owner: name, items: [Item(name: "Example Item", description: "", location: nil, goalDate: Date(), isComplete: true, details: "")], color: Color(uiColor: color))
